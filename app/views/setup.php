				...
				<div class="pure-g">
					...
					<div class="pure-u-1-2">
						...
						<?php if (Session::get('practice_id') == '1') {?>
							...
							<label for="patient_portal">Patient Portal web address</label><input type="text" name="patient_portal" id="patient_portal" class="text" style="width:250px"/><input type="hidden" id="patient_portal_old"/>
						<?php }?>
					</div>
				</div>
			</form>
