...
<div id="messages_edit_ref_location" title="">
	<form id="messages_edit_ref_location_form" class="pure-form pure-form-stacked">
		...
		<div class="pure-g">
			...
			<div class="pure-u-1-3"><label for="messages_ref_location_state">State:</label><select name="state" id="messages_ref_location_state" class="text pure-input-1"></select></div>
