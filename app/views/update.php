...
-->
			<br><br>
			<input type="hidden" id="add_icd_note" value=''/>
			<div id="add_icd_progress"></div><br>
		...
		<div>
			...
			<input type="hidden" id="add_med_note" value=''/>
			<div id="add_med_progress"></div><br>
		...
		<div>
			...
			<input type="hidden" id="add_supplement_note" value=''/>
			<div id="add_supplement_progress"></div><br>
		...
		<div>
			...
			<input type="hidden" id="add_cpt_note" value=''/>
			<div id="add_cpt_progress"></div><br>
		...
		<div>
			...
			<input type="hidden" id="add_npi_note" value=''/>
			<div id="add_npi_progress"></div><br>
		...
		<div>
			...
			<input type="hidden" id="add_cvx_note" value=''/>
			<div id="add_cvx_progress"></div><br>
