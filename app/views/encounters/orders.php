		...
		<div class="pure-u-17-24">
			<div class="pure-g">
				...
				<div class="pure-u-3-4">
					<?php if (Session::get('encounter_template') == 'standardmedical' || Session::get('encounter_template') == 'standardmedical1' || Session::get('encounter_template') == 'clinicalsupport' || Session::get('encounter_template') == 'standardmtm') {?>
				...
				<div class="pure-u-3-4">
					<?php if (Session::get('encounter_template') == 'standardmedical' || Session::get('encounter_template') == 'standardmedical1' || Session::get('encounter_template') == 'clinicalsupport' || Session::get('encounter_template') == 'standardmtm') {?>
						<label for="orders_followup">Follow Up: <span class="textdump_text"></span> for templates.</label>
						<textarea style="width:95%" rows="10" name="followup" id="orders_followup" class="text textdump"></textarea>
					<?php } if (Session::get('encounter_template') == 'standardpsych' || Session::get('encounter_template') == 'standardpsych1') {?>
