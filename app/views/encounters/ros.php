	...
	<div id="ros_psych1_dialog" title="Depression" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych1_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych1_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych1_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych1_normal" class="all_normal nosh_button" value=""><label for="ros_psych1_normal">All Normal</label> <input type="checkbox" id="ros_psych1_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych1_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych2_dialog" title="Anxiety" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych2_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych2_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych2_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych2_normal" class="all_normal nosh_button" value=""><label for="ros_psych2_normal">All Normal</label> <input type="checkbox" id="ros_psych2_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych2_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych3_dialog" title="Bipolar" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych3_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych3_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych3_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych3_normal" class="all_normal nosh_button" value=""><label for="ros_psych3_normal">All Normal</label> <input type="checkbox" id="ros_psych3_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych3_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych4_dialog" title="Mood Disorders" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych4_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych4_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych4_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych4_normal" class="all_normal nosh_button" value=""><label for="ros_psych4_normal">All Normal</label> <input type="checkbox" id="ros_psych4_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych4_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych5_dialog" title="ADHD" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych5_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych5_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych5_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych5_normal" class="all_normal nosh_button" value=""><label for="ros_psych5_normal">All Normal</label> <input type="checkbox" id="ros_psych5_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych5_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych6_dialog" title="PTSD" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych6_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych6_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych6_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych6_normal" class="all_normal nosh_button" value=""><label for="ros_psych6_normal">All Normal</label> <input type="checkbox" id="ros_psych6_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych6_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych7_dialog" title="Substance Related Disorder" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych7_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych7_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych7_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych7_normal" class="all_normal nosh_button" value=""><label for="ros_psych7_normal">All Normal</label> <input type="checkbox" id="ros_psych7_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych7_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych8_dialog" title="Obsessive Compulsive Disorder" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych8_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych8_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych8_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych8_normal" class="all_normal nosh_button" value=""><label for="ros_psych8_normal">All Normal</label> <input type="checkbox" id="ros_psych8_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych8_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych9_dialog" title="Social Anxiety Disorder" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych9_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych9_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych9_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych9_normal" class="all_normal nosh_button" value=""><label for="ros_psych9_normal">All Normal</label> <input type="checkbox" id="ros_psych9_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych9_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych10_dialog" title="Autistic Disorder" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych10_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych10_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych10_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych10_normal" class="all_normal nosh_button" value=""><label for="ros_psych10_normal">All Normal</label> <input type="checkbox" id="ros_psych10_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych10_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
	...
	<div id="ros_psych11_dialog" title="Asperger's Disorder" style="overflow:hidden;">
		<div class="pure-g">
			<div class="pure-u-13-24">
				...
				<br><button type="button" id="ros_psych11_hpi" class="per_hpi nosh_button">Per HPI</button><button type="button" id="ros_psych11_nc" class="nc nosh_button">Noncontributory</button><button type="button" id="ros_psych11_reset" class="reset nosh_button">Clear</button>
			</div>
			<div class="pure-u-11-24">
				<form class="pure-form pure-form-stacked">
				...
				<input type="checkbox" id="ros_psych11_normal" class="all_normal nosh_button" value=""><label for="ros_psych11_normal">All Normal</label> <input type="checkbox" id="ros_psych11_normal1" class="all_normal1_ros nosh_button" value=""><label for="ros_psych11_normal1">All Normal for All Templates</label><br>
				<div class="ros_template_div">
