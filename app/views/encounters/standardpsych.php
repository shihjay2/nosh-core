<?php echo HTML::script('/js/standardpsych.js');?>
<div id="noshtabs">
	<div id="encounter_tabs">
		<ul>
			...
			<?php }?>
			<?php if(Session::get('group_id') == '2') {?>
				<li id="encounter_tabs_assessment"><a href="#encounter_tabs_6">DX</a></li>
			<?php }?>
			<li id="encounter_tabs_orders"><a href="#encounter_tabs_7">Treatment Plan</a></li>
		</ul>
		<?php if(Session::get('group_id') == '2') {?>
			<div id="encounter_tabs_1" style="overflow:auto">
				<div id="hpi_form" class="pure-g">
					<div class="pure-u-13-24">
						...
						<br><button type="button" id="hpi_reset" class="reset nosh_button">Clear</button>
					</div>
