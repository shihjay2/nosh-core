...
<div id="assessment_buttons">
	...
	<button type="button" id="assessment_select_icd_9" class="nosh_button">Additional Diagnosis</button>
	<button type="button" id="assessment_select_icd_10" class="nosh_button">Differential Diagnosis</button>
</div>
...
<form id="assessment_form" class="pure-form pure-form-stacked">
	...
	<div id="assessment_icd8_div_button" style="display:none"><span id="assessment_icd8_div"></span> <button type="button" id="clear_icd_8" class="nosh_button_cancel assessment_clear">Clear</button><br></div><br>
	<div class="pure-g">
