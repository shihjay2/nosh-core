	...
	<div class="pure-g">
		...
		<?php } if (Session::get('encounter_template') == 'standardpsych' || Session::get('encounter_template') == 'standardpsych1') {?>
			...
			<div class="pure-u-1-2">
				<span id="button_pe_neuro_status" class="pe_tooltip"></span>
				<input type="hidden" id="num_pe_neuro" value="3"/><button type="button" id="button_pe_neuro" class="nosh_button pe_menu_button">Neurological</button><br><br>
				<span id="button_pe_mental_status" class="pe_tooltip"></span>
				<input type="hidden" id="num_pe_mental" value="1"/><button type="button" id="button_pe_mental" class="nosh_button pe_menu_button">Mental Status Exam</button><br><br>
			</div>
		<?php }?>
	</div>
</form>
	...
	<div id="pe_constitutional_dialog" class="pe_dialog" title="Constitutional">
		...
		<div id="pe_constitutional_accordion">
			...
			<div class="pure-g">
				<div class="pure-u-11-24">
					<form class="pure-form pure-form-stacked">
						<label for="pe_constitutional1">Preview: <span class="textdump_text"></span> for templates.</label><textarea style="width:95%" rows="20" name="pe_constitutional1" id="pe_constitutional1" class="pe_entry text textdump"></textarea><input type="hidden" id="pe_constitutional1_old"/>
					</form>
				</div>
				<div class="pure-u-13-24">
					<form class="pure-form pure-form-stacked">
						<label for="pe_constitutional1_template">Choose Template:</label><select id="pe_constitutional1_template" class="pe_template_choose text"></select><br>
					</form>
					<input type="checkbox" id="pe_constitutional1_normal" class="all_normal_pe nosh_button" value=""><label for="pe_constitutional1_normal">All Normal</label><button type="button" id="pe_constitutional1_reset" class="reset nosh_button">Clear</button><br>
					<div class="pe_template_div">
						<br><form id="pe_constitutional1_form" class="pe_template_form ui-widget pure-form"></form>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="pe_mental_dialog" class="pe_dialog" title="Mental Status Examination">
		...
		<div id="pe_mental_accordion">
			...
			<div class="pure-g">
				<div class="pure-u-11-24">
					<form class="pure-form pure-form-stacked">
						<label for="pe_mental1">Preview: <span class="textdump_text"></span> for templates.</label><textarea style="width:95%" rows="20" name="pe_mental1" id="pe_mental1" class="pe_entry text textdump"></textarea><input type="hidden" id="pe_mental1_old"/>
					</form>
				</div>
				<div class="pure-u-13-24">
					<form class="pure-form pure-form-stacked">
						<label for="pe_mental1_template">Choose Template:</label><select id="pe_mental1_template" class="pe_template_choose text"></select><br>
					</form>
					<input type="checkbox" id="pe_mental1_normal" class="all_normal_pe nosh_button" value=""><label for="pe_mental1_normal">All Normal</label><button type="button" id="pe_mental1_reset" class="reset nosh_button">Clear</button><br>
					<div class="pe_template_div">
						<br><form id="pe_mental1_form" class="pe_template_form ui-widget pure-form"></form>
					</div>
				</div>
			</div>
		</div>
