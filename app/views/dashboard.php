			...
			<div class="pure-g">
				<div class="pure-u-1-2">
					...
					<?php if(Session::get('group_id') == '2') {?>
						...
						<br><?php echo HTML::image('images/email.png', 'Messages', array('border' => '0', 'height' => '40', 'width' => '40', 'style' => 'vertical-align:middle;'));?><span> You have <?php echo $number_messages;?> </span><a href="#" id="dashboard_messaging">messages to view.</a>
