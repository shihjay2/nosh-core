		...
		<?php if ($patient_centric == 'y') {?>
			<div id="box" class="ui-corner-all ui-tabs ui-widget ui-widget-content">
				<div id="openid_box" class="pure-g">
					...
					<div class="pure-u-1"><?php echo link_to_route('oidc', "I'm a Provider using mdNOSH Gateway", $parameters = array(), $attributes = array('class'=>'nosh_button'));?><br><br></div>
					<div class="pure-u-1"><?php echo link_to_route('google_auth', "I'm a Provider using Google", $parameters = array(), $attributes = array('class'=>'nosh_button'));?></div>
