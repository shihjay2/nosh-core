...
<div id="encounter_text">
	...
	<?php } else {?>
		<strong>Age at Date of Service: </strong><?php echo $age1;?><br>
		<strong>Date of Service: </strong><?php echo $encounter_DOS;?><br>
		<strong>Provider: </strong><?php echo $encounter_provider;?><br>
	<?php }?>
	<hr class="ui-state-default"/>
