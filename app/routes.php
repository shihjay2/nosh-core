...
{
	if(route('home') == 'https://hieofone.com/nosh' || route('home') == 'https://cloud.noshchartingsystem.com/nosh' || route('home') == 'https://noshchartingsystem.com/nosh' || route('home') == 'https://www.noshchartingsystem.com/nosh' || route('home') == 'https://shihjay.xyz/nosh' || route('home') == 'https://agropper.xyz/nosh') {
		$row = Practiceinfo::find(1);
