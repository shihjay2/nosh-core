<?php namespace RxNormApis;
use ApiBaseClass;
//require_once('ApiBaseClasses.php');
...
class RxNormApi extends ApiBaseClass
{
	...
	public function _request($path, $method, $data = null, $headers = null)
	{
	...
	public function getRxProperty($rxcui = null, $propName)
	{
		$rxcui = self::getRxcui($rxcui);
		return self::_request("/rxcui/$rxcui/property?propName=$propName", 'GET');
	}
	
	public function getApproximateMatch($term,$maxEntries,$option)
	{
		return self::_request("/approximateTerm?term=$term&maxEntries=$maxEntries&option=$option", 'GET');
	}
}
